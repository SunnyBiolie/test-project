...
export const ButtonChangeImage = ({
  ...
  return (
    <div
      className={cn(
        "absolute top-1/2 -translate-y-1/2 bg-neutral-800/75 rounded-full size-8 flex items-center justify-center cursor-pointer hover:bg-neutral-800/50 transition-all",
